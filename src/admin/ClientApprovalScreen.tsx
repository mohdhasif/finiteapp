...
const ClientApprovalScreen = () => {
  ...
  //     if (data.success) Alert.alert('Success', 'Client updated successfully');
  //     else Alert.alert('Error', data.error || 'Update failed');
  //   } catch (error) {
  ...
  //     } else Alert.alert('Error', data.error || 'Approval failed');
  //   } catch (error) {
  //     Alert.alert('Error', 'Server error');
  //   }
  //   setLoading(false);
